...
let Template = (_dec = Prop({
  default: true
}), _dec2 = Prop(), Component(_class = (_class2 = (_temp = class Template extends TsComponent {
  constructor(...args) {
    super(...args);

    _initializerDefineProperty(this, "mif", _descriptor, this);
...
}, _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "mif", [_dec], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "tag", [_dec2], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
